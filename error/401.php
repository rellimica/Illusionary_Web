...
<body>
    ...
    <div class="error-card">
        ...
        <h1 class="error-title">Identification Required</h1>
        <p class="error-text">We couldn't verify your credentials. Please log in to gain access to this area.</p>
        <a href="/auth.php" class="btn">Go to Login</a>
    </div>
</body>
</html>
