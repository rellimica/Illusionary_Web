            ...
            <section class="section-card">
                ...
                <div class="legal-box" id="legalWall" onscroll="handleLegalScroll(this)">
                    ...
                    $sections = [
                        ...
                        "V. RESIDUAL ASSET MANAGEMENT AND NEXT OF KIN" => "In the event of total structural de-cohesion, the Company will activate the 'Residual Asset Management' protocol. This involves the collection of all data cards and physical residues for re-integration into the next kernel version. The Emergency Contact listed will be notified of dispersal via the standard 'System Error' broadcast. The Company does not guarantee the return of the Vessel's original silhouette or linear history.",
